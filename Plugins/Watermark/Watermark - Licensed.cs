...
namespace ImageResizer.Plugins.Watermark
{
    ...
    public class WatermarkPlugin : LegacyWatermarkFeatures, IPlugin, IQuerystringPlugin
    {
        ...
        private static Guid featureId = new Guid("cada8f47-c26a-4b95-bbb5-a6d53f1549db");
        public WatermarkPlugin() {
            ImageResizer.Licensing.Methods.SetFeatureName(Config.Current, featureId, "R3-Watermark");
        }
        ...
        protected override RequestedAction PrepareDestinationBitmap(ImageState s) {
            if (!string.IsNullOrEmpty(s.settings["watermark"]))
                ImageResizer.Licensing.Methods.NotifyUse(Config.Current, featureId);
